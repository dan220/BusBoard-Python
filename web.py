...
def busInfo():
    ...
    board_1, stop_1 = bus_board.return_board(first_stop_atcocode)
    board_2, stop_2 = bus_board.return_board(second_stop_atcocode)
    return render_template('info.html', postcode=postcode, board=board_1)
